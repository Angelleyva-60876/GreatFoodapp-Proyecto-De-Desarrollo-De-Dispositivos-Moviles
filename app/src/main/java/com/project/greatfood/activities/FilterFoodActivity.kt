...
import com.project.greatfood.adapter.FilterFoodAdapter
import com.project.greatfood.model.ModelFilter
...
class FilterFoodActivity : AppCompatActivity(), FilterFoodAdapter.onSelectData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Aqui utilizaremos el toolbar que seria la parte de arriba (el titulo)
        toolbar_filter.setTitle(null)
        setSupportActionBar(toolbar_filter)
        assert(supportActionBar != null)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)

        // La ventana de que estan cargnado los datos
        ...
        if (modelMain != null) {
            ...
            //Set Text de la interfaz para los platillos
            tvTitle.setText("SALIR <- Platillos - $strCategory")
            tvDescCategories.setText(strCategoryDescription)

            //Get image Aparecera de fondo en el cuadro
            Glide.with(this)
            ...
            //Get image Aparecera de fondo en los platillos
            Glide.with(this)
                    .load(modelMain!!.strCategoryThumb)
                    .placeholder(R.drawable.ic_food_placeholder)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
            ...
            AndroidNetworking.get(Api.Filter)
                    ...
                    .getAsJSONObject(object : JSONObjectRequestListener {
                        ...
                        override fun onError(anError: ANError) {
                            progressDialog!!.dismiss()
                            Toast.makeText(this@FilterFoodActivity,"No hay conexion a internet!", Toast.LENGTH_SHORT).show()
                        }
                    })
        }
